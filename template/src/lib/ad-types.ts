export const AD_FORMATS = ["nativeBanner", "banner728x90", "banner300x250", "banner468x60", "sidebar160x600", "sidebar160x300", "mobile320x50"] as const;

export type AdFormat = (typeof AD_FORMATS)[number];
export type AdAvailability = Record<AdFormat, boolean>;

export const AD_SIZES: Record<Exclude<AdFormat, "nativeBanner">, { width: number; height: number }> = {
