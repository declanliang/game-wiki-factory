...
class CoreTests(unittest.TestCase):
    ...
    def test_language_selection_requires_independent_evidence(self):
        candidates = [
        ...
        self.assertEqual(_select_language_codes([]), ["en", "es"])
        self.assertEqual(_select_language_codes(candidates), ["en", "es", "ja"])
