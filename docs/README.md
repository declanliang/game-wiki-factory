...
- `deployment/cloudflare-workers-static-assets.md`：Cloudflare Workers Static Assets 发布合同。
- `advertising/adsterra-environment-contract.md`：shared ad profile、Worker vars 和模板展示合同。
