...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate validated Roblox wiki homepage data from game names.")
    parser.add_argument("games", nargs="+", help="One or more Roblox game names; quote names containing spaces.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    for game in args.games:
        ...
        try:
            output_dir, validation = Pipeline(settings).run(game)
