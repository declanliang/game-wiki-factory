...
def main():
    ...
    parser.add_argument(
        "--project-dir",
        help=(
            "Use this exact directory for all project data. Put this option "
            "before the subcommand; intended for orchestrated per-game runs."
        ),
    )
    ...
    if args.project_dir:
        os.environ["SEOSCOUT_PROJECT_DIR"] = os.path.abspath(os.path.expanduser(args.project_dir))
